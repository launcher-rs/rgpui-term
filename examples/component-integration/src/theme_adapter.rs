...
impl ThemeAdapter {
    ...
    fn default_red() -> Hsla {
        rgpui_term::hsla_from_rgb(0xE0, 0x6C, 0x75)
    }

    fn default_green() -> Hsla {
        rgpui_term::hsla_from_rgb(0x98, 0xC3, 0x79)
    }

    fn default_yellow() -> Hsla {
        rgpui_term::hsla_from_rgb(0xE5, 0xC0, 0x7B)
    }

    fn default_blue() -> Hsla {
        rgpui_term::hsla_from_rgb(0x61, 0xAF, 0xEF)
    }

    fn default_magenta() -> Hsla {
        rgpui_term::hsla_from_rgb(0xC6, 0x78, 0xDD)
    }

    fn default_cyan() -> Hsla {
        rgpui_term::hsla_from_rgb(0x56, 0xB6, 0xC2)
    }
}
...
pub trait ComponentThemeExt {
    ...
    fn apply_component_theme(&mut self, cx: &mut rgpui::Context<Self>)
    where
        Self: Sized;
...
impl ComponentThemeExt for rgpui_term::TerminalView {
    fn apply_component_theme(&mut self, cx: &mut rgpui::Context<Self>) {
